...
1. Run `learn` (or `learn test`) to see where you stand. 
...
3. Get all the tests to pass! Once you're passing all tests, your work will be submitted to Canvas. Head back to the Canvas assignment to confirm and continue learning!
